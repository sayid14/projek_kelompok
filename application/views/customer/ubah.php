									...
									<form action="<?= base_url('customer/proses_ubah/' . $customer->kode) ?>" id="form-tambah" method="POST">
										...
										<div class="form-row">
											<div class="form-group col-md-8">
												...
												<input type="email" name="email" placeholder="Masukkan Email" autocomplete="off" class="form-control" required value="<?= $customer->email ?>">
											</div>
										...
										<div class="form-group">
											...
											<textarea name="alamat" id="alamat" style="resize: none;" class="form-control" placeholder="Masukkan Alamat"><?= $customer->alamat ?></textarea>
										</div>
										<hr>
										<div class="form-group">
